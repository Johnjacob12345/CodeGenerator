...
def print_logic_info(shooterTabs=None):
    ...
    with open(f"{destination_directory}\\folderTest\\fileTest.txt", "r") as file:
        content = file.readlines()


    content.insert(0, "//It works!\n")
# Write back the modified content
    with open(f"{destination_directory}\\folderTest\\fileTest.txt", "w") as file:
